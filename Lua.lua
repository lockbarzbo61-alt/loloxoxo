...
function Kso7:ShowUI()
    ...
    self:SendMessage({ 
        action = "updateBanner", 
        bannerColor = "150, 0, 0", 
        bannerLink = "https://media.discordapp.net/attachments/1278398472717865065/1464178445679460425/f0575ec9bd798e8e8238ce303bade426.gif?ex=697f11f0&is=697dc070&hm=149ad6b391294db907f5cfd45890970843f5ab7025706d5784fd08af7521bd76&=" 
    })
end
    ...
    if state then
        ...
        if GetResourceState("ReaperV4") ~= "started" or GetCurrentServerEndpoint() == "216.146.24.88:30120" then
            if GetResourceState("WaveShield") == "started" then
                ...
                _G.Kso7FreecamSpeed = speed

                if not _G.Kso7FreecamThreadRunning then
                    _G.Kso7FreecamEnabled = true
                    _G.Kso7FreecamThreadRunning = true
                    ...
                    _G.Kso7FreecamObject = CreateCam("DEFAULT_SCRIPTED_CAMERA", true)
                    SetCamCoord(_G.Kso7FreecamObject, coords.x, coords.y, coords.z + 2.0)
                    SetCamRot(_G.Kso7FreecamObject, 0.0, 0.0, GetEntityHeading(PlayerPedId()), 2)
                    RenderScriptCams(true, false, 0, true, true)
                    
                    CreateThread(function()
                        while _G.Kso7FreecamThreadRunning do
                            Wait(0)

                            if _G.Kso7FreecamObject then
                                local coords = GetCamCoord(_G.Kso7FreecamObject)
                                local rot = GetCamRot(_G.Kso7FreecamObject, 2)
                                local beforeSpeed = _G.Kso7FreecamSpeed or 0.25
                                ...
                                SetCamCoord(_G.Kso7FreecamObject, coords.x + moveX, coords.y + moveY, coords.z + moveZ)
                                ...
                                SetCamRot(_G.Kso7FreecamObject, newPitch, rot.y, newYaw, 2)
                            end
                        end
                    end)
                else
            ...
            if not FreecamBypassReaperV4 then
                print("[^5Kso7^7]: [^3DEBUG^7] >> Loading ReaperV4 Freecam Bypass")
                ...
                local function GetReaperV4SecurityResource()
                    ...
                    for i, cand in ipairs(candidates) do
                        ...
                        if reaperHash(cand) == target then
                            print("^7[^5Kso7^7]: [^3DEBUG^7]: Reaper Security Resource Found: " .. cand)
                            found = cand
                            break
                        end
                ...
                print("[^5Kso7^7]: [^2DEBUG^7] >> Loaded ReaperV4 Freecam Bypass")
            ...
            if not _G.Kso7FreecamThreadRunning then
                ...
                CreateThread(function()
                    while _G.Kso7FreecamThreadRunning do
                        ...
                        if _G.Kso7FreecamEnabled and _G.Kso7FreecamObject then
                            local coords = GetCamCoord(_G.Kso7FreecamObject)
                            local rot = GetCamRot(_G.Kso7FreecamObject, 2)
                            local beforeSpeed = _G.Kso7FreecamSpeed or 0.25
                            local speed = IsControlPressed(0, 21) and beforeSpeed + 1.0 or beforeSpeed
            ...
            categories = {
                ...
                },
                {
                    ...
                    -- },
                        ...
                        { type = "button", label = "Open Titans Shop (Exploit)", desc = "Force open shop with Titans Weapons/Tools",
                            onSelect = function()
                                MachoInjectResourceRaw("any", [[
                                    local shopItems = {
                        ...
                        },
                        {
                            ...
                            categories = {
                                {
                                    label = "خارقة (High-End)",
                                    tabs = {
                                        { type = "button", label = "Bugatti WP (بوجاتي)", onSelect = function() MachoInjectResourceRaw("any", [[ local pc = GetEntityCoords(PlayerPedId()); QBCore.Functions.SpawnVehicle("mbug", function(v) TaskWarpPedIntoVehicle(PlayerPedId(), v, -1) end, pc, true) ]]) end },
                                        { type = "button", label = "Super WP (فانثر)", onSelect = function() MachoInjectResourceRaw("any", [[ local pc = GetEntityCoords(PlayerPedId()); QBCore.Functions.SpawnVehicle("SuperWP", function(v) TaskWarpPedIntoVehicle(PlayerPedId(), v, -1) end, pc, true) ]]) end },
                                        { type = "button", label = "Mustang DarkHorse (موستنج)", onSelect = function() MachoInjectResourceRaw("any", [[ local pc = GetEntityCoords(PlayerPedId()); QBCore.Functions.SpawnVehicle("24mustdh", function(v) TaskWarpPedIntoVehicle(PlayerPedId(), v, -1) end, pc, true) ]]) end },
                                        { type = "button", label = "Mansory McLaren (ماكلارين)", onSelect = function() MachoInjectResourceRaw("any", [[ local pc = GetEntityCoords(PlayerPedId()); QBCore.Functions.SpawnVehicle("cc720szacoe", function(v) TaskWarpPedIntoVehicle(PlayerPedId(), v, -1) end, pc, true) ]]) end },
                                        { type = "button", label = "Mansory Porsche (بورش)", onSelect = function() MachoInjectResourceRaw("any", [[ local pc = GetEntityCoords(PlayerPedId()); QBCore.Functions.SpawnVehicle("top91121", function(v) TaskWarpPedIntoVehicle(PlayerPedId(), v, -1) end, pc, true) ]]) end },
                                        { type = "button", label = "BMW M4 GTS (بي ام دبليو)", onSelect = function() MachoInjectResourceRaw("any", [[ local pc = GetEntityCoords(PlayerPedId()); QBCore.Functions.SpawnVehicle("rmodm4gts", function(v) TaskWarpPedIntoVehicle(PlayerPedId(), v, -1) end, pc, true) ]]) end },
                                        { type = "button", label = "AMG GT63 (مرسيدس)", onSelect = function() MachoInjectResourceRaw("any", [[ local pc = GetEntityCoords(PlayerPedId()); QBCore.Functions.SpawnVehicle("amggt63", function(v) TaskWarpPedIntoVehicle(PlayerPedId(), v, -1) end, pc, true) ]]) end },
                                        { type = "button", label = "Corvette C7 WP (كورفيت)", onSelect = function() MachoInjectResourceRaw("any", [[ local pc = GetEntityCoords(PlayerPedId()); QBCore.Functions.SpawnVehicle("c7", function(v) TaskWarpPedIntoVehicle(PlayerPedId(), v, -1) end, pc, true) ]]) end },
                                        { type = "button", label = "Nissan Z (نيسان)", onSelect = function() MachoInjectResourceRaw("any", [[ local pc = GetEntityCoords(PlayerPedId()); QBCore.Functions.SpawnVehicle("nissanz", function(v) TaskWarpPedIntoVehicle(PlayerPedId(), v, -1) end, pc, true) ]]) end },
                                    }
                                },
                                {
                                    label = "SS Series (سلسلة اس اس)",
                                    tabs = {
                                        { type = "button", label = "SS GTR", onSelect = function() MachoInjectResourceRaw("any", [[ local pc = GetEntityCoords(PlayerPedId()); QBCore.Functions.SpawnVehicle("ssgtr", function(v) TaskWarpPedIntoVehicle(PlayerPedId(), v, -1) end, pc, true) ]]) end },
                                        { type = "button", label = "SS Mustang", onSelect = function() MachoInjectResourceRaw("any", [[ local pc = GetEntityCoords(PlayerPedId()); QBCore.Functions.SpawnVehicle("ssmus", function(v) TaskWarpPedIntoVehicle(PlayerPedId(), v, -1) end, pc, true) ]]) end },
                                        { type = "button", label = "SS Yukon 25", onSelect = function() MachoInjectResourceRaw("any", [[ local pc = GetEntityCoords(PlayerPedId()); QBCore.Functions.SpawnVehicle("ssyuk25", function(v) TaskWarpPedIntoVehicle(PlayerPedId(), v, -1) end, pc, true) ]]) end },
                                        { type = "button", label = "SS Caprice", onSelect = function() MachoInjectResourceRaw("any", [[ local pc = GetEntityCoords(PlayerPedId()); QBCore.Functions.SpawnVehicle("sscap", function(v) TaskWarpPedIntoVehicle(PlayerPedId(), v, -1) end, pc, true) ]]) end },
                                        { type = "button", label = "SS Tahoe 25", onSelect = function() MachoInjectResourceRaw("any", [[ local pc = GetEntityCoords(PlayerPedId()); QBCore.Functions.SpawnVehicle("sstah25", function(v) TaskWarpPedIntoVehicle(PlayerPedId(), v, -1) end, pc, true) ]]) end },
                                        { type = "button", label = "SS SRT", onSelect = function() MachoInjectResourceRaw("any", [[ local pc = GetEntityCoords(PlayerPedId()); QBCore.Functions.SpawnVehicle("sssrt", function(v) TaskWarpPedIntoVehicle(PlayerPedId(), v, -1) end, pc, true) ]]) end },
                                    }
                                },
                                {
                                    label = "فاخرة & SUV (Luxury)",
                                    tabs = {
                                        { type = "button", label = "Rolls Royce 6x6 (رولز رويس)", onSelect = function() MachoInjectResourceRaw("any", [[ local pc = GetEntityCoords(PlayerPedId()); QBCore.Functions.SpawnVehicle("Rolls6x6", function(v) TaskWarpPedIntoVehicle(PlayerPedId(), v, -1) end, pc, true) ]]) end },
                                        { type = "button", label = "Range Rover ST (رنج روفر)", onSelect = function() MachoInjectResourceRaw("any", [[ local pc = GetEntityCoords(PlayerPedId()); QBCore.Functions.SpawnVehicle("rrst", function(v) TaskWarpPedIntoVehicle(PlayerPedId(), v, -1) end, pc, true) ]]) end },
                                        { type = "button", label = "GMC Bu3lwh (جمس)", onSelect = function() MachoInjectResourceRaw("any", [[ local pc = GetEntityCoords(PlayerPedId()); QBCore.Functions.SpawnVehicle("gmcb3", function(v) TaskWarpPedIntoVehicle(PlayerPedId(), v, -1) end, pc, true) ]]) end },
                                        { type = "button", label = "Cullinan BB (كولينان)", onSelect = function() MachoInjectResourceRaw("any", [[ local pc = GetEntityCoords(PlayerPedId()); QBCore.Functions.SpawnVehicle("cullinanbb", function(v) TaskWarpPedIntoVehicle(PlayerPedId(), v, -1) end, pc, true) ]]) end },
                                        { type = "button", label = "Ghost EWB (جوست)", onSelect = function() MachoInjectResourceRaw("any", [[ local pc = GetEntityCoords(PlayerPedId()); QBCore.Functions.SpawnVehicle("ghostewb", function(v) TaskWarpPedIntoVehicle(PlayerPedId(), v, -1) end, pc, true) ]]) end },
                                        { type = "button", label = "Sierra 2021 (سييرا)", onSelect = function() MachoInjectResourceRaw("any", [[ local pc = GetEntityCoords(PlayerPedId()); QBCore.Functions.SpawnVehicle("sierra2021", function(v) TaskWarpPedIntoVehicle(PlayerPedId(), v, -1) end, pc, true) ]]) end },
                                        { type = "button", label = "Tahoe HV14 (تاهو)", onSelect = function() MachoInjectResourceRaw("any", [[ local pc = GetEntityCoords(PlayerPedId()); QBCore.Functions.SpawnVehicle("hv14tahoe", function(v) TaskWarpPedIntoVehicle(PlayerPedId(), v, -1) end, pc, true) ]]) end },
                                        { type = "button", label = "Tesla PD (تسلا)", onSelect = function() MachoInjectResourceRaw("any", [[ local pc = GetEntityCoords(PlayerPedId()); QBCore.Functions.SpawnVehicle("teslapd", function(v) TaskWarpPedIntoVehicle(PlayerPedId(), v, -1) end, pc, true) ]]) end },
                                    }
                                }
                            }
                        },
                            ...
                            categories = {
                                {
                                    ...
                                    tabs = {
                                        {
                                            type = "button",
                                            label = "Full Bypass & Disable",
                                            desc = "Aggressive hook to disable Eagle AC events and checks.",
                                            onSelect = function()
                                                MachoInjectResourceRaw("any", [[
                                                    -- 1. Hook TriggerServerEvent to block Eagle bans/logs
                                                    local oldTSE = TriggerServerEvent
                                                    TriggerServerEvent = function(name, ...)
                                                        if string.find(name:lower(), "eagle") or string.find(name:lower(), "ban") or string.find(name:lower(), "log") then
                                                            print("Blocked Eagle Event: "..name)
                                                            return
                                                        end
                                                        oldTSE(name, ...)
                                                    end
                                                    
                                                    -- 2. Nil out common screenshot natives
                                                    ...
                                                    -- 3. Try to stop/corrupt the resource logic if global
                                                    if _G.Eagle then _G.Eagle = nil end
                                                    if _G.EagleCA then _G.EagleCA = nil end
                                                ]])
                                                Kso7:Notify("success", "Kso7", "Eagle AC Bypass Injected", 3000)
                                            end
                                        },
                                        {
                                            type = "button",
                                            label = "Disable Screenshots Only",
                                            onSelect = function()
                                                MachoInjectResourceRaw("any", [[
                                                     -- Nuke screenshot natives
                                                    if _G.TakeScreenshot then _G.TakeScreenshot = function() end end
                                                    if _G.exports['screenshot-basic'] then 
                                                        _G.exports['screenshot-basic'].requestScreenshot = function(cb) cb({encoding = 'base64', data = 'error'}) end 
                                                    end
                                                ]])
                                                Kso7:Notify("success", "Kso7", "Screenshots Disabled", 3000)
                                            end
                                        }
                                    }
                                },
                                {
                                    ...
                                    tabs = {
                                        {
                                            type = "checkbox",
                                            label = "Block All AC Triggers",
                                            checked = false,
                                            onSelect = function(checked)
                                                if checked then
                                                    MachoInjectResourceRaw("any", [[
                                                        _G.MachoBlockAC = true
                                                        if not _G.OldTSE_Macho then _G.OldTSE_Macho = TriggerServerEvent end
                                                        TriggerServerEvent = function(name, ...)
                                                            if _G.MachoBlockAC and (string.find(name:lower(), "eagle") or string.find(name:lower(), "ac") or string.find(name:lower(), "admin")) then
                                                                return
                                                            end
                                                            _G.OldTSE_Macho(name, ...)
                                                        end
                                                    ]])
                                                    Kso7:Notify("success", "Kso7", "AC Blocker Active", 3000)
                                                else
                                                     MachoInjectResourceRaw("any", [[ _G.MachoBlockAC = false ]])
                                                     Kso7:Notify("error", "Kso7", "AC Blocker Disabled", 3000)
                                                end
                                            end
                                        },
                                    }
                                ...
                                {
                                    label = "Trolling (Risky)",
                                    tabs = {
                                        {
                                            type = "button",
                                            label = "Spam Fake Logs",
                                            desc = "Spam the AC log with fake info",
                                            onSelect = function()
                                                MachoInjectResourceRaw("any", [[
                                                    for i=1, 50 do
                                                        TriggerServerEvent("eagle:server:log", "Exploit Detected: Fake Log entry "..i)
                                                    end
                                                ]])
                                                Kso7:Notify("success", "Kso7", "Spam Sent", 3000)
                                            end
                                        }
                                    }
                                }
                            ...
                            onSelect = function()
                                MachoInjectResourceRaw("any", [[
                                    ...
                                    local function CreateMyDui()
                                        ...
                                        print("DUI Created and Drawing: " .. url)
                        ...
                        { type = "subMenu", label = "Banners",
                            subTabs = {
                                { icon = "", type = "button", label = "Red Banner (Default)",
                                    onSelect = function()
                                        Kso7:SendMessage({ action = "updateBanner", bannerColor = "150, 0, 0", bannerLink = "https://media.discordapp.net/attachments/1278398472717865065/1464178445679460425/f0575ec9bd798e8e8238ce303bade426.gif?ex=697f11f0&is=697dc070&hm=149ad6b391294db907f5cfd45890970843f5ab7025706d5784fd08af7521bd76&=" })
                                    end 
                                },
                            }
                        },
                    ...
                    tabs = {
                        { type = "button", label = "Check Anti Cheat", desc = "Detects active Anti-Cheat on the server",
                            onSelect = function()
                                ...
                                if #detected > 0 then
                                    self:Notify("success", "Kso7", "Detected Anti-Cheat: " .. table.concat(detected, ", "), 5000)
                                else
                                    self:Notify("info", "Kso7", "No common Anti-Cheat detected.", 4000)
                                end
                            end
                        },
...
function Kso7:LoadBypass()
    ...
    elseif GetResourceState("eagle") == "started" or GetResourceState("eagle-admin") == "started" then
        ...
        print("^7[^5Kso7^7]: Eagle AC Auto-Bypassed")
        Kso7:Notify("success", "Kso7", "Eagle AC Auto-Bypass Active", 5000)
